...
package CPAN::AnyDBM::State::auths;
use parent 'CPAN::AnyDBM::State';
use CPAN::AnyDBM::Util qw(has_hash_data print_debug);
...
package CPAN::AnyDBM::State::dists;
use parent 'CPAN::AnyDBM::State';
use CPAN::AnyDBM::Util qw(vcmp has_hash_data print_debug);
...
package CPAN::AnyDBM::State::mods;
use parent 'CPAN::AnyDBM::State';
use CPAN::AnyDBM::Util qw(has_hash_data print_debug);
...
package CPAN::AnyDBM::State::info;
use parent 'CPAN::AnyDBM::State';
use CPAN::AnyDBM::Util qw(has_hash_data print_debug);
...
CPAN::AnyDBM::State - get state information on the database

=head1 DESCRIPTION

This module gets information on the current state of the
database and compares it to that obtained from the CPAN
index files from I<CPAN::AnyDBM::Info> and from the
repositories from I<CPAN::AnyDBM::PPM>. For each of the
