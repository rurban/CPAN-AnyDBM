...
sub vcmp {
  my ($v1, $v2) = @_;
  return CPAN::AnyDBM::Version->vcmp($v1, $v2);
}
...
CPAN::AnyDBM::Util - export some common data structures used by CPAN::AnyDBM::*
