...
use File::Basename;
use Safe;
use CPAN::AnyDBM::Util qw(vcmp print_debug);
...
CPAN::AnyDBM::Info - extract information from CPAN indices
...
A C<CPAN::AnyDBM::Info> object is created with

    my $info = CPAN::AnyDBM::Info->new(CPAN => $cpan);
