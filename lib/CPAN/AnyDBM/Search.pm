...
use utf8;
use CPAN::AnyDBM::Util qw($mode_info);
...
sub new {
  my ($class, %args) = @_;
  $cdbi_query = CPAN::AnyDBM::DBI::Search->new(%args);
...
sub query {
  ...
  my $class = 'CPAN::AnyDBM::DBI::Search::' . $table;
...
package CPAN::AnyDBM::Search::author;
use parent 'CPAN::AnyDBM::Search';
...
package CPAN::AnyDBM::Search::module;
use parent 'CPAN::AnyDBM::Search';
...
package CPAN::AnyDBM::Search::dist;
use parent 'CPAN::AnyDBM::Search';
...
CPAN::AnyDBM::Search - perform queries on the database

=head1 SYNOPSIS

  my $max_results = 200;
  my $query = CPAN::AnyDBM::Search->new(db_dir => $db_dir,
                                        db_name => $db_name,
...
C<CPAN::AnyDBM::Search> object is created via the C<new> method as
...
within C<CPAN::AnyDBM::Search> will be used.
...
the mode and on the type of query. See L<CPAN::AnyDBM::Populate>
