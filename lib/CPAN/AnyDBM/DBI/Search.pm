...
package CPAN::AnyDBM::DBI::Search;
...
use parent 'CPAN::AnyDBM::DBI';
use CPAN::AnyDBM::DBI qw($tables $dbh);
use CPAN::AnyDBM::Util qw($full_id);

package CPAN::AnyDBM::DBI::Search::info;
use parent 'CPAN::AnyDBM::DBI::Search';
use CPAN::AnyDBM::DBI qw($dbh);

package CPAN::AnyDBM::DBI::Search::chaps;
use parent 'CPAN::AnyDBM::DBI::Search';
use CPAN::AnyDBM::DBI qw($dbh);

package CPAN::AnyDBM::DBI::Search::mods;
use parent 'CPAN::AnyDBM::DBI::Search';
use CPAN::AnyDBM::DBI qw($dbh);

package CPAN::AnyDBM::DBI::Search::dists;
use parent 'CPAN::AnyDBM::DBI::Search';
use CPAN::AnyDBM::DBI qw($dbh);

package CPAN::AnyDBM::DBI::Search::auths;
use parent 'CPAN::AnyDBM::DBI::Search';
use CPAN::AnyDBM::DBI qw($dbh);
...
use parent 'CPAN::AnyDBM::DBI';
use CPAN::AnyDBM::DBI qw($tables $dbh);
use CPAN::AnyDBM::Util qw($full_id expand_dslip download %chaps);
...
sub fetch_and_set {
  ...
  die "Please supply a CPAN::AnyDBM::Meta::* object"
    unless ($meta_obj and ref($meta_obj) =~ /^CPAN::AnyDBM::META/);
...
CPAN::AnyDBM::DBI::Search - DBI information for searching the CPAN::AnyDBM database

=head1 DESCRIPTION

This module provides methods for L<CPAN::AnyDBM::Search> for searching
the C<CPAN::AnyDBM> database. There are two main methods.

=over

=item C<fetch>

This takes information from C<CPAN::AnyDBM::Search> and sets up
