...
package CPAN::AnyDBM::DBI::Index::info;
use parent 'CPAN::AnyDBM::DBI::Index';
use CPAN::AnyDBM::DBI qw($dbh);

package CPAN::AnyDBM::DBI::Index::chaps;
use parent 'CPAN::AnyDBM::DBI::Index';
use CPAN::AnyDBM::DBI qw($dbh);

package CPAN::AnyDBM::DBI::Index::mods;
use parent 'CPAN::AnyDBM::DBI::Index';
use CPAN::AnyDBM::DBI qw($dbh);

package CPAN::AnyDBM::DBI::Index::dists;
use parent 'CPAN::AnyDBM::DBI::Index';
use CPAN::AnyDBM::DBI qw($dbh);
...
package CPAN::AnyDBM::DBI::Index::auths;
use parent 'CPAN::AnyDBM::DBI::Index';
use CPAN::AnyDBM::DBI qw($dbh);
...
CPAN::AnyDBM::DBI::Index - DBI information for indexing the CPAN::AnyDBM database

=head1 DESCRIPTION

This module provides various methods for L<CPAN::AnyDBM::Index> in
