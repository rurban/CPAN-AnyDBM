...
CPAN::AnyDBM::DBI - DBI information for the CPAN::AnyDBM database

=head1 DESCRIPTION

This module is used by L<CPAN::AnyDBM::Index> and
L<CPAN::AnyDBM::Search> to set up some basic database
...
This is a L<AnyDBM> database handle used to connect to the
database.
...
L<CPAN::AnyDBM::Index> and L<CPAN::AnyDBM::Search>
